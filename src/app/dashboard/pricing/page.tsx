...
const tiers = [
  ...
  },
  {
    ...
    href: "#", // Replace with Lemon Squeezy link
    popular: true,
  },
   {
    name: "Pro",
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4">
      <div className="text-center space-y-4 mb-12">
        <h1 className="text-3xl md:text-4xl font-headline font-bold">Choose Your Plan</h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Select the plan that best fits your job search needs and career goals to continue.
        </p>
      </div>
